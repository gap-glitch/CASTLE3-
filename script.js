...
var geomTailPlane = new THREE.BoxGeometry(0,0,0,1,1,1);
...
var geomSideWing = new THREE.BoxGeometry(0,0,0,1,1,1);
...
var geomPropeller = new THREE.BoxGeometry(0,0,0,1,1,1);
...
var geomBlade = new THREE.BoxGeometry(0,0,0,0,0,0);
...
Sea = function(){
var geom = new THREE.BoxGeometry(9100,9100,800,40,10);
...
var tx = 0 (event.clientX / WIDTH)*2;
var ty = 0 (event.clientY / HEIGHT)*2;
mousePos = {x:tx, y:ty};
}
